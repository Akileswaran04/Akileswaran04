...
CONTRAST = 1.12
BRIGHTNESS = 1.0
GAMMA = 1.28          # >1 brightens mids -> face lands in sparser chars
SHARPEN = False
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'f'akileswaran04@github: ~$ whoami <tspan fill="{INK}">Akileswaran A</tspan></text>')
