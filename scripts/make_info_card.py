...
ROWS = [
    ("host",),
    ("kv", "Now", "B.Tech IT @ CEG, Anna University"),
    ("kv", "Stack", "React · Node · Firebase · PostgreSQL"),
    ("kv", "AI / ML", "XGBoost, LLMs, Multi-Agent Sys"),
    ("kv", "Edu", "9.31 CGPA · CEG, Anna University"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React.js, React Native, Responsive Web"),
    ("kv", "Backend", "Node/Express, Firebase, PostgreSQL"),
    ("kv", "ML / AI", "XGBoost, LightGBM, Isolation Forest"),
    ("kv", "Tools", "Git, Streamlit, FastAPI, VS Code"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Multi-Agent AI System for Fintech (SBI YONO)"),
    ("bul", "Sentri: ML Dashboard for Bengaluru Traffic Police"),
    ("bul", "ParkIQ: 300K-row violation analytics pipeline"),
    ("bul", "DayLog: Real-time attendance tracking app"),
    ("bul", "Gridlock: Traffic demand forecasting (LightGBM)"),
]
