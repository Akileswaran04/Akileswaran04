...
ROWS = [
    ...
    ("kv", "AI / ML", "XGBoost, LightGBM, EBM, DBSCAN"),
    ("kv", "Full-Stack", "React, Node/Express, Firebase, FastAPI"),
    ("kv", "Practice", "Debugging, Testing, Agile, Git/GitHub"),
    ("gap",),
    ("sec", "Projects"),
    ("bul", "ODYSSEY: Multi-Agent AI for Fintech (SBI YONO)"),
    ("bul", "SENTRI: ML Dashboard for Bengaluru Traffic Police"),
    ("bul", "Gridlock: Traffic Demand Forecasting (XGBoost)"),
    ("bul", "DayLog: Real-Time Attendance Tracking (React)"),
    ("bul", "Riddle Rush: 3D Trivia Board Game (Three.js)"),
]
